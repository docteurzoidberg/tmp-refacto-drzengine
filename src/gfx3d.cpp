...
drz::GFX3D::vec3d drz::GFX3D::Math::Mat_MultiplyVector(drz::GFX3D::mat4x4 &m,
                                                       drz::GFX3D::vec3d &i) {
  vec3d v;
...
drz::GFX3D::mat4x4 drz::GFX3D::Math::Mat_MakeIdentity() {
  drz::GFX3D::mat4x4 matrix;
  matrix.m[0][0] = 1.0f;
  matrix.m[1][1] = 1.0f;
  matrix.m[2][2] = 1.0f;
  matrix.m[3][3] = 1.0f;
...
drz::GFX3D::mat4x4 drz::GFX3D::Math::Mat_MakeRotationX(float fAngleRad) {
  drz::GFX3D::mat4x4 matrix;
  matrix.m[0][0] = 1.0f;
...
drz::GFX3D::mat4x4 drz::GFX3D::Math::Mat_MakeRotationY(float fAngleRad) {
  drz::GFX3D::mat4x4 matrix;
...
drz::GFX3D::mat4x4 drz::GFX3D::Math::Mat_MakeRotationZ(float fAngleRad) {
  drz::GFX3D::mat4x4 matrix;
  matrix.m[0][0] = cosf(fAngleRad);
...
drz::GFX3D::mat4x4 drz::GFX3D::Math::Mat_MakeScale(float x, float y, float z) {
  drz::GFX3D::mat4x4 matrix;
  matrix.m[0][0] = x;
  matrix.m[1][1] = y;
  matrix.m[2][2] = z;
...
drz::GFX3D::mat4x4 drz::GFX3D::Math::Mat_MakeTranslation(float x, float y,
                                                         float z) {
  drz::GFX3D::mat4x4 matrix;
  matrix.m[0][0] = 1.0f;
  matrix.m[1][1] = 1.0f;
...
drz::GFX3D::mat4x4 drz::GFX3D::Math::Mat_MakeProjection(float fFovDegrees,
                                                        float fAspectRatio,
                                                        float fNear,
                                                        float fFar) {
...
drz::GFX3D::mat4x4
drz::GFX3D::Math::Mat_MultiplyMatrix(drz::GFX3D::mat4x4 &m1,
                                     drz::GFX3D::mat4x4 &m2) {
  drz::GFX3D::mat4x4 matrix;
  for (int c = 0; c < 4; c++)
    for (int r = 0; r < 4; r++)
...
drz::GFX3D::mat4x4 drz::GFX3D::Math::Mat_PointAt(drz::GFX3D::vec3d &pos,
                                                 drz::GFX3D::vec3d &target,
                                                 drz::GFX3D::vec3d &up) {
  // Calculate new forward direction
  drz::GFX3D::vec3d newForward = Vec_Sub(target, pos);
  newForward = Vec_Normalise(newForward);

  // Calculate new Up direction
  drz::GFX3D::vec3d a = Vec_Mul(newForward, Vec_DotProduct(up, newForward));
  drz::GFX3D::vec3d newUp = Vec_Sub(up, a);
  newUp = Vec_Normalise(newUp);

  // New Right direction is easy, its just cross product
  drz::GFX3D::vec3d newRight = Vec_CrossProduct(newUp, newForward);
...
drz::GFX3D::mat4x4 drz::GFX3D::Math::Mat_QuickInverse(drz::GFX3D::mat4x4 &m) {
  drz::GFX3D::mat4x4 matrix;
...
drz::GFX3D::mat4x4 drz::GFX3D::Math::Mat_Inverse(drz::GFX3D::mat4x4 &m) {
  double det;
  ...
  det = m.m[0][0] * matInv.m[0][0] + m.m[0][1] * matInv.m[1][0] +
        m.m[0][2] * matInv.m[2][0] + m.m[0][3] * matInv.m[3][0];
...
drz::GFX3D::vec3d drz::GFX3D::Math::Vec_Add(drz::GFX3D::vec3d &v1,
                                            drz::GFX3D::vec3d &v2) {
  return {v1.x + v2.x, v1.y + v2.y, v1.z + v2.z};
}

drz::GFX3D::vec3d drz::GFX3D::Math::Vec_Sub(drz::GFX3D::vec3d &v1,
                                            drz::GFX3D::vec3d &v2) {
  return {v1.x - v2.x, v1.y - v2.y, v1.z - v2.z};
}

drz::GFX3D::vec3d drz::GFX3D::Math::Vec_Mul(drz::GFX3D::vec3d &v1, float k) {
  return {v1.x * k, v1.y * k, v1.z * k};
}

drz::GFX3D::vec3d drz::GFX3D::Math::Vec_Div(drz::GFX3D::vec3d &v1, float k) {
  return {v1.x / k, v1.y / k, v1.z / k};
}

float drz::GFX3D::Math::Vec_DotProduct(drz::GFX3D::vec3d &v1,
                                       drz::GFX3D::vec3d &v2) {
  return v1.x * v2.x + v1.y * v2.y + v1.z * v2.z;
}

float drz::GFX3D::Math::Vec_Length(drz::GFX3D::vec3d &v) {
  return sqrtf(Vec_DotProduct(v, v));
}

drz::GFX3D::vec3d drz::GFX3D::Math::Vec_Normalise(drz::GFX3D::vec3d &v) {
  float l = Vec_Length(v);
  return {v.x / l, v.y / l, v.z / l};
}

drz::GFX3D::vec3d drz::GFX3D::Math::Vec_CrossProduct(drz::GFX3D::vec3d &v1,
                                                     drz::GFX3D::vec3d &v2) {
  vec3d v;
...
drz::GFX3D::vec3d drz::GFX3D::Math::Vec_IntersectPlane(
  ...
  t = (-plane_d - ad) / (bd - ad);
  drz::GFX3D::vec3d lineStartToEnd = Vec_Sub(lineEnd, lineStart);
  drz::GFX3D::vec3d lineToIntersect = Vec_Mul(lineStartToEnd, t);
  return Vec_Add(lineStart, lineToIntersect);
}

int drz::GFX3D::Math::Triangle_ClipAgainstPlane(vec3d plane_p, vec3d plane_n,
                                                triangle &in_tri,
                                                triangle &out_tri1,
                                                triangle &out_tri2) {
  ...
  if (nInsidePointCount == 1 && nOutsidePointCount == 2) {
    ...
    float t;
    out_tri1.p[1] = Math::Vec_IntersectPlane(
        plane_p, plane_n, *inside_points[0], *outside_points[0], t);
    out_tri1.t[1].x =
        t * (outside_tex[0]->x - inside_tex[0]->x) + inside_tex[0]->x;
    out_tri1.t[1].y =
        t * (outside_tex[0]->y - inside_tex[0]->y) + inside_tex[0]->y;
    out_tri1.t[1].z =
        t * (outside_tex[0]->z - inside_tex[0]->z) + inside_tex[0]->z;

    out_tri1.p[2] = Math::Vec_IntersectPlane(
        plane_p, plane_n, *inside_points[0], *outside_points[1], t);
    out_tri1.t[2].x =
        t * (outside_tex[1]->x - inside_tex[0]->x) + inside_tex[0]->x;
    out_tri1.t[2].y =
        t * (outside_tex[1]->y - inside_tex[0]->y) + inside_tex[0]->y;
    out_tri1.t[2].z =
        t * (outside_tex[1]->z - inside_tex[0]->z) + inside_tex[0]->z;
  ...
  if (nInsidePointCount == 2 && nOutsidePointCount == 1) {
    ...
    out_tri2.p[2] = Math::Vec_IntersectPlane(
        plane_p, plane_n, *inside_points[1], *outside_points[0], t);
    out_tri2.t[2].x =
        t * (outside_tex[0]->x - inside_tex[1]->x) + inside_tex[1]->x;
    out_tri2.t[2].y =
        t * (outside_tex[0]->y - inside_tex[1]->y) + inside_tex[1]->y;
    out_tri2.t[2].z =
        t * (outside_tex[0]->z - inside_tex[1]->z) + inside_tex[1]->z;
...
void GFX3D::DrawTriangleFlat(drz::GFX3D::triangle &tri) {
  _gfx->FillTriangle((int32_t)tri.p[0].x, (int32_t)tri.p[0].y,
                     (int32_t)tri.p[1].x, (int32_t)tri.p[1].y,
                     (int32_t)tri.p[2].x, (int32_t)tri.p[2].y, tri.col[0]);
}

void GFX3D::DrawTriangleWire(drz::GFX3D::triangle &tri, drz::Color col) {
  _gfx->DrawTriangle((int32_t)tri.p[0].x, (int32_t)tri.p[0].y,
                     (int32_t)tri.p[1].x, (int32_t)tri.p[1].y,
...
void GFX3D::DrawTriangleTex(drz::GFX3D::triangle &tri, drz::Sprite *spr) {}
...
void GFX3D::PipeLine::SetProjection(float fFovDegrees, float fAspectRatio,
                                    float fNear, float fFar, float fLeft,
                                    float fTop, float fWidth, float fHeight) {
  matProj =
      GFX3D::Math::Mat_MakeProjection(fFovDegrees, fAspectRatio, fNear, fFar);
  fViewX = fLeft;
  fViewY = fTop;
  fViewW = fWidth;
  fViewH = fHeight;
...
void GFX3D::PipeLine::SetCamera(drz::GFX3D::vec3d &pos,
                                drz::GFX3D::vec3d &lookat,
                                drz::GFX3D::vec3d &up) {
  matView = GFX3D::Math::Mat_PointAt(pos, lookat, up);
  matView = GFX3D::Math::Mat_QuickInverse(matView);
}

void GFX3D::PipeLine::SetTransform(drz::GFX3D::mat4x4 &transform) {
  matWorld = transform;
}

void GFX3D::PipeLine::SetTexture(drz::Sprite *texture) {
  sprTexture = texture;
  // bUseMipMap = false;
}

/*void GFX3D::PipeLine::SetMipMapTexture(drz::GFX3D::MipMap *texture)
{
        sprMipMap = texture;
        bUseMipMap = true;
}*/

void GFX3D::PipeLine::SetLightSource(uint32_t nSlot, uint32_t nType,
                                     drz::Color col, drz::GFX3D::vec3d pos,
                                     drz::GFX3D::vec3d dir, float fParam) {
  if (nSlot < 4) {
...
uint32_t GFX3D::PipeLine::Render(std::vector<drz::GFX3D::triangle> &triangles,
                                 uint32_t flags) {
  return Render(triangles, flags, 0, triangles.size());
}

uint32_t GFX3D::PipeLine::RenderLine(drz::GFX3D::vec3d &p1,
                                     drz::GFX3D::vec3d &p2, drz::Color col) {
  ...
  _gfx->DrawLine((int32_t)t1.x, (int32_t)t1.y, (int32_t)t2.x, (int32_t)t2.y,
                 col);

  return 0;
}

uint32_t GFX3D::PipeLine::RenderCircleXZ(drz::GFX3D::vec3d &p1, float r,
                                         drz::Color col) {
  // Coordinates are assumed to be in world space
  drz::GFX3D::vec3d t1;
  drz::GFX3D::vec3d t2 = {p1.x + r, p1.y, p1.z};
  ...
  _gfx->FillCircle((int32_t)t1.x, (int32_t)t1.y, (int32_t)fabs(t2.x - t1.x),
                   col);
...
uint32_t GFX3D::PipeLine::Render(std::vector<drz::GFX3D::triangle> &triangles,
                                 uint32_t flags, int nOffset, int nCount) {
  ...
  for (int tx = nOffset; tx < nOffset + nCount; tx++) {
    ...
    triTransformed.p[0] =
        GFX3D::Math::Mat_MultiplyVector(matWorldView, tri.p[0]);
    triTransformed.p[1] =
        GFX3D::Math::Mat_MultiplyVector(matWorldView, tri.p[1]);
    triTransformed.p[2] =
        GFX3D::Math::Mat_MultiplyVector(matWorldView, tri.p[2]);

    // TODO apply model translations
    // TODO apply model rotations
    ...
    if (flags & RENDER_LIGHTS) {
      ...
      triTransformed.col[0] =
          drz::Color(uint8_t(nLightR * triTransformed.col[0].r),
                     uint8_t(nLightG * triTransformed.col[0].g),
                     uint8_t(nLightB * triTransformed.col[0].b));
      triTransformed.col[1] =
          drz::Color(uint8_t(nLightR * triTransformed.col[1].r),
                     uint8_t(nLightG * triTransformed.col[1].g),
                     uint8_t(nLightB * triTransformed.col[1].b));
      triTransformed.col[2] =
          drz::Color(uint8_t(nLightR * triTransformed.col[2].r),
                     uint8_t(nLightG * triTransformed.col[2].g),
                     uint8_t(nLightB * triTransformed.col[2].b));

      /*GFX3D::vec3d light_dir = { 1,1,1 };
      light_dir = GFX3D::Math::Vec_Normalise(light_dir);
      float light = GFX3D::Math::Vec_DotProduct(light_dir, normal);
      if (light < 0) light = 0;
      triTransformed.col[0] = drz::Color(light * 255.0f, light * 255.0f, light *
      255.0f); triTransformed.col[1] = drz::Color(light * 255.0f, light *
      255.0f, light * 255.0f); triTransformed.col[2] = drz::Color(light *
      255.0f, light * 255.0f, light * 255.0f);*/
    }
    // else
    //	triTransformed.col = drz::WHITE;

    // Clip triangle against near plane
    int nClippedTriangles = 0;
    GFX3D::triangle clipped[2];
    nClippedTriangles = GFX3D::Math::Triangle_ClipAgainstPlane(
        {0.0f, 0.0f, 0.1f}, {0.0f, 0.0f, 1.0f}, triTransformed, clipped[0],
        clipped[1]);
    ...
    for (int n = 0; n < nClippedTriangles; n++) {
      ...
      triProjected.p[0] =
          GFX3D::Math::Mat_MultiplyVector(matProj, clipped[n].p[0]);
      triProjected.p[1] =
          GFX3D::Math::Mat_MultiplyVector(matProj, clipped[n].p[1]);
      triProjected.p[2] =
          GFX3D::Math::Mat_MultiplyVector(matProj, clipped[n].p[2]);
      ...
      for (auto &triRaster : listTriangles) {
        ...
        //{/*
        //	TexturedTriangle(
        //		triRaster.p[0].x, triRaster.p[0].y, triRaster.t[0].x,
        // triRaster.t[0].y, triRaster.t[0].z, 		triRaster.p[1].x,
        // triRaster.p[1].y, triRaster.t[1].x, triRaster.t[1].y,
        // triRaster.t[1].z, 		triRaster.p[2].x, triRaster.p[2].y,
        // triRaster.t[2].x, triRaster.t[2].y, triRaster.t[2].z,
        // sprTexture);*/

        //	RasterTriangle(
        //		triRaster.p[0].x, triRaster.p[0].y, triRaster.t[0].x,
        // triRaster.t[0].y, triRaster.t[0].z, triRaster.col,
        // triRaster.p[1].x, triRaster.p[1].y, triRaster.t[1].x,
        // triRaster.t[1].y, triRaster.t[1].z, triRaster.col,
        // triRaster.p[2].x, triRaster.p[2].y, triRaster.t[2].x,
        // triRaster.t[2].y, triRaster.t[2].z, triRaster.col,
        // sprTexture,
        // nFlags);
        ...
        if (flags & RENDER_WIRE) {
          ...
          RasterTriangle((int)triRaster.p[0].x, (int)triRaster.p[0].y,
                         triRaster.t[0].x, triRaster.t[0].y, triRaster.t[0].z,
                         triRaster.col[0], (int)triRaster.p[1].x,
                         (int)triRaster.p[1].y, triRaster.t[1].x,
                         triRaster.t[1].y, triRaster.t[1].z, triRaster.col[1],
                         (int)triRaster.p[2].x, (int)triRaster.p[2].y,
                         triRaster.t[2].x, triRaster.t[2].y, triRaster.t[2].z,
                         triRaster.col[2], sprTexture, flags);
        }
...
void GFX3D::RasterTriangle(int x1, int y1, float u1, float v1, float w1,
...

{
  ...
  float dax_step = 0, dbx_step = 0, du1_step = 0, dv1_step = 0, du2_step = 0,
        ...
        dcg1_step = 0, dcg2_step = 0, dcb1_step = 0, dcb2_step = 0,
...
// GFX3D::MipMap::MipMap() : drz::Sprite(){}
// GFX3D::MipMap::MipMap(std::string sImageFile) : drz::Sprite(sImageFile)
//{
//	GenerateMipLevels();
// }
// GFX3D::MipMap::MipMap(std::string sImageFile, drz::ResourcePack *pack) :
// drz::Sprite(sImageFile, pack){} GFX3D::MipMap::MipMap(int32_t w, int32_t h) :
// drz::Sprite(w, h) {}
...
//			for (int y = 0; y < h; y++)
//				pge->Draw(x, y,
// vecMipMaps[i-1].SampleBL((float)x / (float)w, (float)y / (float)h));
// w >>= 1; h >>= 1;
//	}
...
//}
//
// drz::rcode GFX3D::MipMap::LoadFromFile(std::string sImageFile,
// drz::ResourcePack *pack)
//{
//	drz::rcode r = drz::Sprite::LoadFromFile(sImageFile, pack);
//	if (r == drz::FAIL) return r;
//	GenerateMipLevels();
//	return r;
//}

// drz::rcode GFX3D::MipMap::LoadFromPGESprFile(std::string sImageFile,
// drz::ResourcePack *pack)
//{
//	drz::rcode r = drz::Sprite::LoadFromPGESprFile(sImageFile, pack);
//	if (r == drz::FAIL) return r;
//	GenerateMipLevels();
//	return r;
// }
//
// drz::Color GFX3D::MipMap::Sample(float x, float y, float z)
//{
//	int nLevel = (int)(z * (float)vecMipMaps.size());
//	return vecMipMaps[nLevel].Sample(x, y);
// }

// drz::Color GFX3D::MipMap::SampleBL(float u, float v, float z);
